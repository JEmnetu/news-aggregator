        ...
        <>
            <Col sm={12} md={6} className="mb-4">
                <Card className="h-100 d-flex flex-column" >
                    <Card.Img variant="top" src={bookmark.image_url} style={{ height: '200px', objectFit: 'cover' }} />
                    <Card.Body>
                        ...
                        <Row className="d-flex justify-content-between align-items-center mt-auto">
                            <Col xs="auto">
                                <Button variant="primary" href={bookmark.article_url} className="mb-1">Read More</Button></Col>
                            <Col xs="auto">
